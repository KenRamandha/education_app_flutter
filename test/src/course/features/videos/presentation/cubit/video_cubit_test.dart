...
void main() {
  ...
  group('addVideo', () {
    ...
    blocTest<VideoCubit, VideoState>(
      'emits [AddingVideo, VideoError] when addVideo is called fails',
      build: () {
  ...
  group('getVideos', () {
    blocTest<VideoCubit, VideoState>(
      'emits [LoadingVideos, VideosLoaded]',
      build: () {
    ...
    blocTest<VideoCubit, VideoState>(
      'emits [LoadingVideos, VideoError] whrn getVideos is called fails',
      build: () {
