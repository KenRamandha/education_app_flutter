...
void main() {
  ...
  group('addVideo', () {
    test(
        'should complete successfully when '
    ...
    test(
        ...
        'to remote source is unSuccessfull', () async {
  ...
  group('getVideos', () {
    test(
      'should return [List<Video>] when call to remote source is successfull',
      () async {
